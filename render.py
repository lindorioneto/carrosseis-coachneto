...
from brand import C, W, H, GRAPHICS, ILUSTRA, MARCA, aplicar_cor
...
.vignette{{position:absolute;inset:0;
  background:radial-gradient(120% 78% at 50% 0%,{_rgba(C['orange'], '.10')} 0%,rgba(7,7,7,0) 60%)}}
...
.foot b span{{color:{MARCA}}}
.arraste{{color:{C['orange']}}}
"""

def chevron():
    return ('<svg viewBox="0 0 300 460" fill="none">'
            '<path d="M40 20 L250 230 L40 440" stroke="' + C["orange"] + '" stroke-width="30"/></svg>')
